            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <i class="fa fa-search"></i></asp:LinkButton>
                                            ...
                                            <asp:TemplateField HeaderText="LoanAppId" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLoanAppId" runat="server" Text=""></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="CustomerNameFull">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCustomerNameFull" runat="server" Text=""></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="LegalPersonDetail">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLegalPersonDetail" runat="server" Text=""></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="ContractAssetDetail">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblContractAssetDetail" runat="server" Text=""></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" />
                                            </asp:TemplateField>


                                            <asp:TemplateField HeaderText="LoanAppStatusDetail">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLoanAppStatusDetail" runat="server" Text="" Font-Bold="true"></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" />
                                            </asp:TemplateField>
